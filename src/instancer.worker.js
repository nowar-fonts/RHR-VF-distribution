...
function buildFont(weight, roundness, sfnt) {
	const font = fontFromSfnt(sfnt);
...
self.onmessage = (ev) => {
	console.log(ev);
	const { weight, roundness, sfnt } = ev.data;
	console.log(weight, roundness, sfnt);
}
